...
<template>
  <Container>
    <div
      class="sticky top-0 pt-8 pb-3 border-b-2 border-zinc-100 dark:border-zinc-700 z-20"
    >
      Header
    </div>
    ...
    <div class="py-10 lg:py-32">
      ...
      <div v-show="items.length > 0">
        ...
        >
          ...
          <div>
            <div
              class="bg-zinc-100 dark:bg-zinc-800 sticky top-24 rounded-2xl lg:w-96 flex flex-col gap-y-4 justify-between p-4 mb-20 lg:mb-0"
            >
              <span class="opacity-70 block">اطلاعات پرداخت</span>
              <div class="flex items-center justify-between w-full text-sm">
                <span class="block">مبلغ کالاها</span>
                <span>
                  {{
                    items
